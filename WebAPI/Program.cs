...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Codyssi", Version = "v1" });
...
builder.Services.AddSingleton<CodyssiGateway>();
...
//    but because we want to avoid spamming the Codyssi server, we'll assume that this performance is negligible.
